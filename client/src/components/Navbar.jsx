    ...
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-2xl">
        <div className="flex justify-around items-end px-2 pt-2 pb-safe">
          {/* Ana Sayfa */}
          <Link to="/" className={`flex flex-col items-center gap-0.5 py-1 px-2 transition-colors ${isActive('/') ? 'text-romantic-600' : 'text-gray-500'}`}>
          ...
          <Link
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2 transition-colors ${isActive('/gallery') ? 'text-romantic-600' : 'text-gray-500'}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            to="/my-photos"
            className={`flex flex-col items-center gap-0.5 py-1 px-2 transition-colors ${isActive('/my-photos') ? 'text-romantic-600' : 'text-gray-500'}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={isActive('/my-photos') ? 2.5 : 1.8} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
            </svg>
            <span className="text-[10px] font-medium">Yüklediklerim</span>
          </Link>
          ...
          <Link
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2 transition-colors ${isActive('/memories') ? 'text-romantic-600' : 'text-gray-500'}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
